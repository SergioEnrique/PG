...
class PurchaseExamplesController extends Controller
{
     ...
     *   name="nw_paypal_express_checkout_prepare_simple_purchase_doctrine_orm"
     * )
     * 
     * @Extra\Template("NWPaypalExpressCheckoutBundle:PurchaseExamples:prepare.html.twig")
     */
     ...
     *   name="nw_paypal_express_checkout_prepare_simple_purchase_doctrine_mongo_odm"
     * )
     *
     * @Extra\Template("NWPaypalExpressCheckoutBundle:PurchaseExamples:prepare.html.twig")
     */
    public function prepareSimplePurchaseAndDoctrineMongoOdmAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            $storage = $this->getPayum()->getStorage('NW\PaymentBundle\Document\PaymentDetails');
     ...
     *   name="nw_paypal_express_checkout_prepare_digital_goods_purchase"
     * )
     * 
     * @Extra\Template
     */
     ...
     *   name="nw_paypal_express_checkout_prepare_simple_purchase_with_custom_api"
     * )
     *
     * @Extra\Template
     */
     ...
     *   name="nw_paypal_express_checkout_prepare_purchase_with_ipn_enabled"
     * )
     *
     * @Extra\Template("NWPaypalExpressCheckoutBundle:PurchaseExamples:prepare.html.twig")
     */
