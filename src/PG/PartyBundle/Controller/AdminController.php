...
class AdminController extends Controller
{
    public function PanelAction(Request $request)
    {
        ...
        return $this->render('PGPartyBundle:Admin:solicitudesRetiro.html.twig', array(
    ...
    public function aceptarRetiroAction($id)
    {
        ...
        ->setSubject("Tu solicitud de retiro ha sido aceptada en PartyGift")
        ->setFrom("info@newlywishes.com")
        ->setTo($usuario->getEmail())
        ->setContentType("text/html")
        ->setBody(
            $this->renderView(
                'PGPartyBundle:Admin:solicitudRetiroAceptada.html.twig', array(
